        ...
        <div className="prospectDetailLayout">
          <section className="prospectDetailMain">
            ...
            {prospect?.workspace_id ? <section className="prospectOpsPanel prospectCommentsPanel" hidden={detailView !== "activity"}>
              ...
              {comments.length && (showAllSharedNotes || newSharedNoteCount) ? <p className="small prospectListLimitNote">{showAllSharedNotes ? `Showing all ${comments.length} shared notes.` : `Showing ${newSharedNoteCount} new shared ${newSharedNoteCount === 1 ? "note" : "notes"}.`}</p> : null}
